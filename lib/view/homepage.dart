...
import 'package:mycaterers/view/sheduledOrders.dart';
                        ...
                        drawer: Drawer(
                          child: ListView(
                            children: <Widget>[
                             ...
                             Utils. whatsappButton(name:authController.userModel!.name,number: authController.userModel!.phone ),
                              ...
                              orderController.packageinfo == null ? SizedBox() : Center(child: Text('App Version ${orderController.packageinfo!.version}'))
                            ],
                          ),
                        ),
                        appBar: AppBar(
                                                      ...
                                                      Utils.buttonGreen(
                                                        ...
                                                        if (orderController
                                                          ...
                                                          Get.toNamed(RouteNames
                                                              .foodListScreen);
                                                          orderController.formKey.currentState!.reset();
